<div class="form-group{{ $errors->has($name) ? ' has-error' : '' }}">
    ...
    @if(isset($attributes['popover']))
        ...
        {{ Form::textarea($name, $value, ( isset($attributes) ? array_merge( ['class' => 'form-control', 'data-toggle'=>'popover', 'title'=>trans('inputhinttittle.' . $popover), 'data-content'=>trans('inputhinttext.' . $popover)], $attributes ) : ['class' => 'form-control'] ) ) }}
    @else
